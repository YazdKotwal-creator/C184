        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.contentContainer}>
                    ...
                    <View style={{ flex: 0.5 }}>
                        <Text style={styles.contentText}>Try out our cool frames in Virtual Reality</Text>
                    </View>
                    ...
                    <View style={styles.buttonContainer}>
                        <TouchableOpacity onPress={() => this.props.navigation.navigate("Main")}>
                            <View style={{ backgroundColor: "#f0f0f0", paddingLeft: RFValue(0), paddingRight: RFValue(0), paddingTop: RFValue(0), paddingBottom: RFValue(0), borderRadius: RFValue(20) }}>
