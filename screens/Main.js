            ...
            <View style={styles.container}>
                ...
                <View style={styles.framesContainer}>
                    <View style={styles.categoryContainer}>
                        ...
                        <TouchableOpacity style={this.state.selected == "wayfarer" ? styles.categoryBoxSelected : styles.categoryBox} onPress={() => this.setState({ selected: "regular" })}>
                            <Text>Wayfarer</Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={this.state.selected == "rimless" ? styles.categoryBoxSelected : styles.categoryBox} onPress={() => this.setState({ selected: "regular" })}>
                            <Text>Rimless</Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={this.state.selected == "round" ? styles.categoryBoxSelected : styles.categoryBox} onPress={() => this.setState({ selected: "regular" })}>
                            <Text>Round</Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={this.state.selected == "aviator" ? styles.categoryBoxSelected : styles.categoryBox} onPress={() => this.setState({ selected: "regular" })}>
                            <Text>Aviator</Text>
                        </TouchableOpacity>
                    </View>
